...
Take the files in the "Compiled files" folder and copy them to the "scripts" folder in your GTA V directory. Also you need to add a "path.txt" with the directory where you want the json file (that will be read with the python script) to be saved.
